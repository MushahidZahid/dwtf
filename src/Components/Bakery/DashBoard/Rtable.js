...
export default function Rtable() {
    ...
    useEffect(() => {
        // console.log("Hey");
    }, [remainingProd, quantity, rerender2]);
    ...
    const handelMovement = () => {
        ...
        else
        {
            ...
            axios.post(url,
            {
                from: from,
                to: to,
                flavours: JSON.stringify(inputFields),
            },
            {
                headers: {
                  'Authorization': token,
          ...
          ''
            ...
            <Modal
                        ...
                        <div className="col-6">
                            ...
                            >
                                ...
                                {flavlist.map((kis, index)=>{
                                    return(
                                        <option key={index} value={kis.flavour_name}>{kis.flavour_name} ({kis.production - kis.sold})</option>
                                    );
                ...
                <div style={{ justifyContent: 'center'}} className="d-flex">
                    <button style={{width:'180px',}} onClick={addFields} className="b2">Add Flavour</button>
                </div>
